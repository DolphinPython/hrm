...
<hr>
        <div class="row g-3 mb-5 mt-3">
            ...
            <div class="col-md-2" title="Actual Late (Half Day)">
                ...
                <input type="text" class="form-control"  title="Fine Deduction : ---" value="<?= $total_half_day_late; ?>" min="0" readonly>
                <input type="hidden" class="deduction" id="half_day_all" name="half_day_all" value="">
            </div>
            <!-- Half Day Deduction -->
            <div class="col-md-2" title="Late (Half Day) & Cover">
                <label class="form-label">Late (Half Day) & Cover</label>
                <input type="text" class="form-control"  title="Fine Deduction : ---" value="<?= $total_half_day_late_cover; ?>" min="0" readonly>
                <input type="hidden" class="deduction" id="half_day_all" name="half_day_all" value="">
            </div>
