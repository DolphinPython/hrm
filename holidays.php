            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <?php if ($resultrolep['role'] == 'admin' || $resultrolep['role'] == 'super admin') { ?>
    <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_holiday">
...
<?php } ?>
    ...
    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_holiday<?php echo $row['id']; ?>">
