...
if (isset($_GET['employee_id']) && isset($_GET['month']) && isset($_GET['year'])) {
    ...
    $url = "calculate-salary.php?employee_id={$employee_id}&id={$employee_id}&month={$month}&year={$year}";
}
                                ...
                                $employee_name = $emp_row['employee_name'] ?? '';
                                    ...
                                    if (
                                        ...
                                        <?php
                                                    ...
                                                    $late_only = $late + $extra_late + $extra_fine;
...
// echo $fine_amount;
// echo "<br>";
// echo "<br> Half Day Late Covered: ";
// echo $halfd_late_cover;
$total_half_day_late_cover = $halfd_late_cover;
// echo "<br> Half Day Late Not Covered: ";
// echo $halfd_late_not_cover;
$total_half_day_late = $halfd_late_not_cover;
                    ?>
...
// Initial Total (without late checkbox)
$totalDeduction = $leaveDeduct + $halfDayDeduct + $shortDayDeduct;
...
?>
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <h2 class="text-danger mb-2"><?= $employee_name; ?></h2>
                        <h5 class="mb-2"
                    ...
                    <div class="col-md-4">
                        <div class="row  text-right">
                            ...
                            <h5 class="mb-2"
                                ...
                                Working Days: <?= $totalwork_days - $holiday_days ?>*
                            </h5>
                            <h5>
                                Saturdays: <?= $saturday_days ?>
                                <span class="bcolor">|</span>
                                Sundays: <?= $sunday_days ?>
                                <span class="bcolor">|</span>
                ...
                <!-- Short Information Section End Here -->
                ...
                <div class="container mt-4 mb-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="<?= $salary ?>" min="0" readonly>
                        </div>
                        <div class="col-md-3"
                            title="<?= $totalwork_days ?> Working Days = <?= $totalwork_days - $holiday_days ?> Working Days + <?= $holiday_days ?> Holidays">
                            <label for="totalDays" class="form-label">*Total Days</label>
                            <input type="text" class="form-control" value="<?= $totalwork_days ?>" min="0" readonly>
                        </div>
                        <div class="col-md-3">
                            <label for="perDaySalary" class="form-label">Per Day Salary</label>
                            <input type="text" class="form-control" value="<?= $pdsalary ?>" min="0" readonly>
                        </div>
                        <div class="col-md-2">
                            <label for="half_day_fine" class="form-label">Half Day</label>
                            <input type="text" class="form-control" value="<?= $hdsalary ?>" min="0" readonly>
                        </div>
                        <div class="col-md-1">
                            <label for="short_day_fine" class="form-label">Short Day</label>
                            <input type="text" class="form-control" value="<?= $sdsalary ?>" min="0" readonly>
                        </div>
                    </div>
                    <!-- Row One End -->
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-3" title="Present Days">
                            ...
                            <input type="text" class="form-control" value="<?= $present_days ?>" min="0" readonly>
                        </div>
                        ...
                        <div class="col-md-3"
                            ...
                            <input type="text" class="form-control" title="<?= $leaveDeduct ?> Deduction"
                                value="<?= $leave_days ?> L + <?= $absent_days ?> A - <?= $monthly_leaves ?> M = <?= $displayLeaves ?> Leaves"
                                readonly>
                        </div>
                        ...
                        <div class="col-md-3"
                            ...
                            <input type="text" class="form-control" title="Fine Deduction : <?= $halfDayDeduct ?>"
                                value="<?= $total_half_day ?> H - <?= $monthly_half ?> M = <?= $total_half_day_new ?> Half"
                                min="0" readonly>
                        </div>
                        ...
                        <div class="col-md-3" title="Fine Deduction : <?= $lateDeduct ?>">
                            ...
                            <input type="text" class="form-control" title="Fine Deduction : <?= $shortDayDeduct ?>"
                                value="<?= $total_short_day ?> S - <?= $monthly_shorts ?> M = <?= $total_short_day_new ?> Short"
                                min="0" readonly>
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?= $totalDeduction ?>" readonly>
                        </div>
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <?php
                                $afterDeductionSalary = $salary - $totalDeduction;
                            ?>
                            <label for="" class="form-label">After Deduction Salary</label>
                            <input type="text" class="form-control" value="<?= $afterDeductionSalary ?>" readonly>
                        </div>
                    </div>
                    <!-- Row Third End -->

                </div>
                <!-- Salary Calculation Section End -->
                <hr>
                ...
                <?php
                    ...
                    $lates_not_cover = $late_only - $late_cover;
                    // Normal Lates
                    $lateCount = max(0, $lates_not_cover - $relaxation_late);
                ...
                <div class="container mt-4 mb-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-2" title="">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="form-label">Total Late (Half Day)</label>
                                </div>
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <input type="text" class="form-control fineiboxronly"
                                            value="<?= $halfd_late; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control fineiboxronly"
                                                value="<?= $halfd_late_not_cover; ?>" readonly>
                                        </div>
                                        <div class="col-md-3 p-0">
                                            <input type="text" class="form-control fineiboxr fine-input-halfday"
                                                value="<?= $normal_fine ?>" maxlength="4" placeholder="Fine">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control fineiboxronlyr"
                                                name="half_day_fine_not_cover"
                                                value="<?= $halfd_late_not_cover * $normal_fine ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-2" title="">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="form-label">Late (Half Day) - Fine</label>
                                </div>
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <input type="text" class="form-control fineiboxronly" name="half_day_fine"
                                            value="0/-" readonly>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-2" title="">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="form-label">Total Lates</label>
                                </div>
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <input type="text" class="form-control fineiboxronly" value="<?= $late_only; ?>"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control fineiboxronly"
                                                value="<?= $late_cover; ?>" readonly>
                                        </div>
                                        <div class="col-md-3 p-0">
                                            <input type="text" class="form-control fineiboxr fine-input"
                                                value="<?= $normal_fine ?>" maxlength="4" placeholder="Fine">

                                        </div>
                                        <div class="col-md-5">
                                            <input type="text" class="form-control fineiboxronlyr"
                                                name="late_cover_fine" value="<?= $late_cover * $normal_fine ?>"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control fineiboxronly"
                                                value="<?= $lates_not_cover; ?>" readonly>
                                        </div>
                                        <div class="col-md-3 p-0">
                                            <input type="text" class="form-control fineiboxr fine-input"
                                                value="<?= $normal_fine ?>" maxlength="4" placeholder="Fine">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control fineiboxronlyr"
                                                name="lates_not_cover_fine"
                                                value="<?= $lates_not_cover * $normal_fine ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-2" title="">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="form-label">Lates - Fine</label>
                                </div>
                                <div class="col-md-12">
                                    <div class="row m-0">
                                        <input type="text" class="form-control fineiboxronly" name="lates_fine"
                                            value="xxxxx/-" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Fnal Calulation After Fine Deduction -->
                    <div class="row mt-4 g-3">
                        <div class="col-md-3">
                            <label for="" class="form-label">After Deduction Salary</label>
                            <input type="text" class="form-control" name="after_deduction_salary"
                                value="<?= $afterDeductionSalary ?>" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Total Fine Amount</label>
                            <input type="text" class="form-control" name="total_fine_amount" value="0/-" readonly>
                        </div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3">
                            <label for="final_salary" class="form-label">Final Salary</label>
                            <input type="text" class="form-control" name="final_salary" value="xxxxx/-" readonly>
                        </div>
                    </div>
                    <!-- Final Calulation After Fine Deduction End -->

                </div>
                <!-- Late & Deductions Section End Here -->
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    const lateCoverCheckbox = document.querySelector('[name="late_cover_checkbox"]');
                    const lateNotCoverCheckbox = document.querySelector('[name="lates_not_cover_checkbox"]');

                    const lateCoverCount = document.querySelector('[name="late_cover_fine"]')
                        .closest('.row')
                        .querySelector('.fineiboxronly');

                    const lateNotCoverCount = document.querySelector('[name="lates_not_cover_fine"]')
                        .closest('.row')
                        .querySelector('.fineiboxronly');

                    const lateCoverFineInput = document.querySelector('[name="late_cover_fine"]');
                    const lateNotCoverFineInput = document.querySelector('[name="lates_not_cover_fine"]');
                    const totalLateFineInput = document.querySelector('[name="lates_fine"]');

                    const fineInputs = document.querySelectorAll('.fine-input');

                    function calculateLateFines() {

                        const coverCount = parseInt(lateCoverCount.value) || 0;
                        const notCoverCount = parseInt(lateNotCoverCount.value) || 0;

                        const coverFine = parseInt(fineInputs[0].value) || 0;
                        const notCoverFine = parseInt(fineInputs[1].value) || 0;

                        const coverAmount = coverCount * coverFine;
                        const notCoverAmount = notCoverCount * notCoverFine;

                        // always show calculated
                        lateCoverFineInput.value = coverAmount;
                        lateNotCoverFineInput.value = notCoverAmount;

                        let total = 0;

                        if (lateCoverCheckbox.checked) total += coverAmount;
                        if (lateNotCoverCheckbox.checked) total += notCoverAmount;

                        totalLateFineInput.value = total;

                        calculateFinalSalary();
                    }

                    lateCoverCheckbox.addEventListener('change', calculateLateFines);
                    lateNotCoverCheckbox.addEventListener('change', calculateLateFines);

                    fineInputs.forEach(input => {
                        input.addEventListener('input', calculateLateFines);
                    });
                ...
                <!-- Half Day Late & Deductions Section End Here -->
                <script>
                document.addEventListener("DOMContentLoaded", function() {

                    const coverCheckbox = document.querySelector('[name="half_day_cover_checkbox"]');
                    const notCoverCheckbox = document.querySelector('[name="half_day_not_cover_checkbox"]');

                    const coverCount = document.querySelector('[name="half_day_fine_cover"]')
                        .closest('.row')
                        .querySelector('.fineiboxronly');

                    const notCoverCount = document.querySelector('[name="half_day_fine_not_cover"]')
                        .closest('.row')
                        .querySelector('.fineiboxronly');

                    const coverFineInput = document.querySelector('[name="half_day_fine_cover"]');
                    const notCoverFineInput = document.querySelector('[name="half_day_fine_not_cover"]');
                    const totalHalfFineInput = document.querySelector('[name="half_day_fine"]');

                    const fineInputs = document.querySelectorAll('.fine-input-halfday');

                    function calculateHalfDayFines() {

                        const coverQty = parseInt(coverCount.value) || 0;
                        const notCoverQty = parseInt(notCoverCount.value) || 0;

                        const coverFine = parseInt(fineInputs[0].value) || 0;
                        const notCoverFine = parseInt(fineInputs[1].value) || 0;

                        const coverAmount = coverQty * coverFine;
                        const notCoverAmount = notCoverQty * notCoverFine;

                        coverFineInput.value = coverAmount;
                        notCoverFineInput.value = notCoverAmount;

                        let total = 0;

                        if (coverCheckbox.checked) total += coverAmount;
                        if (notCoverCheckbox.checked) total += notCoverAmount;

                        totalHalfFineInput.value = total;

                        calculateFinalSalary();
                    }

                    coverCheckbox.addEventListener('change', calculateHalfDayFines);
                    notCoverCheckbox.addEventListener('change', calculateHalfDayFines);

                    fineInputs.forEach(input => {
                        input.addEventListener('input', calculateHalfDayFines);
                    });

                    calculateHalfDayFines();
                });
                </script>
                <!-- Half Day Late & Deductions Section End Here -->
                ...
                function calculateFinalSalary() {
                    ...
                    const halfDayFine = parseInt(document.querySelector('[name="half_day_fine"]').value) || 0;
                    const lateFine = parseInt(document.querySelector('[name="lates_fine"]').value) || 0;

                    const totalFineInput = document.querySelector('[name="total_fine_amount"]');
                    const afterSalaryInput = document.querySelector('[name="after_deduction_salary"]');
                    const finalSalaryInput = document.querySelector('[name="final_salary"]');

                    const totalFine = halfDayFine + lateFine;
                    totalFineInput.value = totalFine;

                    const afterSalary = parseInt(afterSalaryInput.value) || 0;
                    finalSalaryInput.value = afterSalary - totalFine;
                }
                </script>
                <!-- Final Salary Calculation End -->
