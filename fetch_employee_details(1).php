...
if (isset($_POST['id'])) {
    ...
    $query = "SELECT * FROM archived_employees WHERE id = $emp_id";
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <table class="table table-bordered">
                    ...
                    <tr><th>Designation ID</th><td>' . $row['designation_id'] . '</td></tr>
                    <tr><th>Department ID</th><td>' . $row['department_id'] . '</td></tr>
