...
//$reporting_manager = explode(",", get_reporting_manager($emp_id));
...
.non-clickable {
    ...
    <script language="javascript">
        ...
        function update_personal_information(emp_id, nationality, religion, marital_status) {
            $.ajax({
                type: "GET",
                url: "update_personal_information.php",
                data: "emp_id=" + emp_id + "&nationality=" + nationality + "&religion=" + religion + "&marital_status=" + marital_status,
                success: function (data) {
                    // alert(data);
                }
            });
                                ...
                                <div class="profile-view">
                                    <div class="profile-img-wrap">
                                        <div class="profile-img">
                                            <a href="#"><img src="<?php echo $profile_image; ?>" alt="User Image"></a>
                                        </div>
                                    </div>
...
if (!$emp_id) {
    die("No employee ID provided in URL");
}
...
<style>
    ...
    .progress-bar {
      ...
      document.getElementById('marital_status').value 
                       )" name="button2" id="button2" class="btn btn-primary submit-btn" value="Save">
                                            </div>
    ...
    <div class="card profile-box flex-fill">
        <div class="card-body">
            <h3 class="card-title">Emergency Contact Details
                    ...
                    <a href="#" class="edit-icon1" data-bs-toggle="modal" data-bs-target="#family_info_modal">
                    ...
                    <tbody>
                        ...
                        while ($row_family = mysqli_fetch_assoc($result_family)) { ?>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="javascript:void(0);" class="edit-btn" data-id="<?= $row_family['id'] ?>" 
                                    ...
                                    <a href="javascript:void(0);" class="delete-btn" data-id="<?= $row_family['id'] ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                ...
                                <label><input type="radio" name="dependent" value="0"> No</label>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card profile-box flex-fill">
                                    <div class="card-body">
                                        ...
                                        <div class="experience-box">
                                            ...
                                            <a href="#" class="edit-icon edit-bank-btn" data-bs-toggle="modal"
                                                data-bs-target="#bank_info" data-id="<?php echo $row_bank['id']; ?>">
                                                <i class="fa-solid fa-pencil"></i>
                                                            ...
                                                            <div class="timeline-content">
                                                                ...
                                                                <div>Account holder Name:
                                                                    <?php echo $row_bank['account_holder_name']; ?></div>
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="openBankModal()"><i class="fa-solid fa-add"></i></button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id="bank_details_form">
                                                <input type="hidden" id="bank_id" name="bank_id" value="<?php echo $emp_id; ?>">
                                                <input type="hidden" id="new_id" name="new_id" value="<?php echo $emp_id; ?>">
                                                <!-- Hidden Input for ID -->
                                                <div class="form-scroll">
                                                    <div class="card">
                                                        <div class="card-body">
