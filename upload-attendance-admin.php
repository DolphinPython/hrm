     ...
     <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Upload Attendance (Admin)</h3>
                            <ul class="breadcrumb">
                ...
                <label class="text-danger">Most Important!</label>
                <div class="bg-danger text-warning"> The excel file must be in .xlsx format</div>
                <div class="bg-danger text-warning">Please delete first two sheet tabs before uploading</div>
                <br>
                <!-- /Page Header -->
                
                    <!-- Content Starts -->
                    <!-- Search Filter -->
    <form name="attendance_search_form" id="attendance_search_form" method="post" action="" enctype="multipart/form-data"> 
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3">  
                        <div class="d-grid">
            <input type="submit" name="b1" id="b1" value="Upload" class="btn btn-success">  
                        </div>
                    </div>     
                </div>
