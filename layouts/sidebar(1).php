    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul class="sidebar-vertical">
                <li class="menu-title">
                    <span>Main</span> <?php //echo $_SESSION['id']; 
                                        ?>
                </li>
                <li class="submenu">
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <?php if ($row_session['department_id'] == 4 or $row_session['department_id'] == 6) { ?>
                            ...
                            <li><a class="<?php echo ($page == 'leaves.php') ? 'active' : ''; ?>" href="leaves.php">Leaves (Admin)
                                    <span class="badge rounded-pill bg-primary float-end">1</span></a></li>
                            <li><a class="<?php echo ($page == 'attendance-reports-admin.php') ? 'active' : ''; ?>" href="attendance-reports-admin.php">Attendance (Admin)</a></li>

                            <li><a class="<?php echo ($page == 'attendance-reports-admin.php') ? 'active' : ''; ?>" href="upload-attendance-admin.php">Upload Attendance (Admin)</a></li>
                            ...
                            <li><a class="<?php echo ($page == 'activities.php') ? 'active' : ''; ?>"
                                    href="activities.php">Add Notification</a></li>
                            ...
                            <li><a class="<?php echo ($page == 'category.php') ? 'active' : ''; ?>" href="category.php">Ticket Category</a></li>
                            ...
                            ?>
                            <li>
                                <a class="<?php echo ($page == 'view-ticket.php') ? 'active' : ''; ?>" href="view-ticket.php">
                                    Ticket
                            ...
                            <li><a class="<?php echo ($page == 'harresment.php') ? 'active' : ''; ?>" href="harresment.php"> Add Complaints</a></li>
                        ...
                        <?php } else { ?>
                            ...
                            <li><a class="<?php echo ($page == 'attendance-report-employee.php') ? 'active' : ''; ?>" href="attendance-report-employee.php">Attendance (Employee)</a></li>
                            <li><a class="<?php echo ($page == 'attendance-report-employee-hrm.php') ? 'active' : ''; ?>" href="attendance-report-employee-hrm.php">Daily Attendance (Employee)</a></li>
                            <li><a class="<?php echo ($page == 'companydetails.php') ? 'active' : ''; ?>" href="companydetails.php">Company Details</a></li>

                            <li><a class="<?php echo ($page == 'ticket.php') ? 'active' : ''; ?>" href="ticket.php">Ticket </a></li>
                            <li><a class="<?php echo ($page == 'harresment.php') ? 'active' : ''; ?>" href="harresment.php"> Add Complaints</a></li>
                            <li><a class="<?php echo ($page == 'employee_complaints.php') ? 'active' : ''; ?>" href="employee_complaints.php">Your Complaints</a></li>
                        <?php } ?>

                        <?php if($emp_id_session=='1' || $emp_id_session=='10' || $emp_id_session=='8') { ?>
                            <li><a class="<?php echo ($page == 'all_employee_complaints.php') ? 'active' : ''; ?>" href="all_employee_complaints.php">All Complaints</a></li>
