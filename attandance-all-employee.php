...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="status-div leave-div">
                                <h4><i class="fas fa-calendar-times"></i> Employees on Leave Today
                                    (<?php echo $current_date; ?>)</h4>
                                        ...
                                        <ul>
                                            <?php foreach ($employees_on_leave as $employee) { ?>
                                                <li>
                                                    ...
                                                    Leave from <?php echo date("Y-m-d", strtotime($employee['start_date'])); ?>
                                                    to <?php echo date("Y-m-d", strtotime($employee['end_date'])); ?>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="status-div absent-div">
                                <h4><i class="fas fa-user-times"></i> Employees Absent Today (<?php echo $current_date; ?>)
                                </h4>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-right">
                        ...
                        <?php if ($is_admin && isset($url) && isset($_GET['employee_id']) && isset($_GET['month']) && isset($_GET['year'])) { ?>
                            <a href="<?php echo $url; ?>" target="_blank" class="btn btn-primary">Calculate Salary</a>
                        <?php } ?>
                    </div>
                </div>
                                                ...
                                                for ($day = 1; $day <= $days_in_month; $day++) {
                                                    ...
                                                    if (isset($attendance_records[$current_date]) && $attendance_records[$current_date]['status'] !== 'absent') {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?= $extra_or_remaining_label ? "$extra_or_remaining_label: $extra_or_remaining_time" : 'N/A' ?>
                                                            </td>
                                                            ...
                                                            <?php if ($is_admin) { ?>
                                                                <td>
                                                                    <a href="#" class="btn btn-sm btn-primary edit-btn"
                                                                        data-id="<?= $row['id'] ?>" data-date="<?= $current_date ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $employee_name ?></td>
                                                            <td><?= $current_date ?></td>
                                                            <td colspan="4" class="text-center text-success"><?= $holidays[$current_date] ?>
                                                            </td>
                                                            <td></td>
                                                            <?php if ($is_admin) { ?>
                                                                <td>
                                                                    <a href="#" class="btn btn-sm btn-primary edit-btn" data-id=""
                                                                        data-date="<?= $current_date ?>" data-clockin="" data-clockout="">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                </td>
                                                            <?php } ?>
                                                            ...
                                                            if ($absent_row['status'] === 'absent' && !isset($approved_leaves[$current_date])) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <?php if ($is_admin) { ?>
                                                                        <td>
                                                                            <a href="#" class="btn btn-sm btn-primary edit-btn"
                                                                                data-id="<?= $absent_id ?>" data-date="<?= $current_date ?>"
                                                ...
                                                if ($is_on_leave) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if ($is_admin) { ?>
                                                            <td>
                                                                <a href="#" class="btn btn-sm btn-primary edit-btn" data-id=""
                                                                    data-date="<?= $date ?>" data-clockin="" data-clockout="">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                            </td>
                                                        <?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $logout_display ?></td>
                                                        <td><?= $total_working_time ?? 'N/A' ?></td>
                                                        <td><?= $extra_or_remaining_label ? "$extra_or_remaining_label: $extra_or_remaining_time" : 'N/A' ?>
                                                        </td>
                                                        <td style="color:<?= $status_color ?>"><?= $late_status ?></td>
                                                        <?php if ($is_admin) { ?>
                                                            <td>
                                                                <a href="#" class="btn btn-sm btn-primary edit-btn"
                                                                    data-id="<?= $row['id'] ?>" data-date="<?= $date ?>"
                                                                    data-clockin="<?= date('H:i', strtotime($row['clock_in_time'])) ?>"
                                                                    data-clockout="<?= $clock_out_time ? date('H:i', strtotime($clock_out_time)) : '' ?>">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if ($is_admin) { ?>
                                                            <td>
                                                                <a href="#" class="btn btn-sm btn-primary edit-btn"
                                                                    data-id="<?= $row['id'] ?>" data-date="<?= $date ?>" data-clockin=""
                                                                    data-clockout="">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <!--<button class="btn btn-sm btn-danger delete-btn" 
                ...
                <form id="editForm" method="post" action="update_attendance.php">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="employee_id" id="editEmployeeId"
                            value="<?= isset($_GET['employee_id']) ? htmlspecialchars($_GET['employee_id']) : $_SESSION['id'] ?>">
    ...
    <script>
        ...
        $('.edit-btn').click(function () {
            ...
            var employeeId = '<?= isset($_GET['employee_id']) ? htmlspecialchars($_GET['employee_id']) : $_SESSION['id'] ?>';
