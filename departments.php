...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_department'])) {
    ...
    $query = "INSERT INTO hrm_department (name, code) VALUES ('$name', '$code')";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_department'])) {
    ...
    $name = mysqli_real_escape_string($conn, $_POST['name']);
    $code = mysqli_real_escape_string($conn, $_POST['code']);
    $query = "UPDATE hrm_department SET name='$name', code='$code' WHERE id='$id'";
    if (mysqli_query($conn, $query)) {
        header("Location: departments.php"); // Redirect to refresh the page
        exit();
    } else {
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="">
                                                                ...
                                                                <div class="input-block mb-3">
                                                                    ...
                                                                    <input class="form-control" name="name" value="<?php echo htmlspecialchars($department['name']); ?>" type="text" required>
                                                                </div>
                                                                <div class="input-block mb-3">
                                                                    <label class="col-form-label">Department Code <span class="text-danger">*</span></label>
                                                                    <input class="form-control" name="code" value="<?php echo htmlspecialchars($department['code']); ?>" type="text" required>
                                                                </div>
