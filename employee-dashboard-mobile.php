...
<head>
    ...
    <script>
        (function () {
            ...
            if (width <= 1000) {
                if (!window.location.pathname.includes('employee-dashboard-mobile.php')) {
                    window.location.href = 'employee-dashboard-mobile.php';
                }
            } else {
                if (!window.location.pathname.includes('employee-dashboard.php')) {
                            ...
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <div class="exp1">
                                        ...
                                        <div class="">
                                            ...
                                            <div id="divB" style="display:none;">
                                                <div class="alert alert-warning text-center">
                                                    ...
                                                    You must be within <span id="maxDistanceText"></span> of the office
                                                    to clock in/out.
                                                </div>
                                            </div>
                                        ...
                                        const officeLat = 28.635262;
                                        const officeLon = 77.283311;
                                            ...
                                            if (navigator.geolocation) {
                                                navigator.geolocation.getCurrentPosition(
                                                    function(position) {
                                                        ...
                                                        distance = calculateDistance(userLat, userLon, officeLat,
                                                            officeLon);
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="attendance-report-employee-hrm.php"
                                    ...
                                    <div class="calendar-container">
                                        <div class="calendar-header-custom">
                                            <button class="btn btn-outline-secondary btn-sm"
                                                id="prevMonthcustom">❮</button>
                                            <h5 id="monthYearcustom"></h5>
                                            <button class="btn btn-outline-secondary btn-sm"
                                                id="nextMonthcustom">❯</button>
                                        </div>
