...
">
            ...
            <form method="GET" class="mb-4">
                <div class="row">
                    <div class="col-md-4">
                        <input type="text" name="asset_name" class="form-control" placeholder="Search by Asset Name"
                            value="<?= isset($_GET['asset_name']) ? $_GET['asset_name'] : '' ?>">
                    </div>
                    <div class="col-md-4">
                        <input type="text" name="asset_id" class="form-control" placeholder="Search by Asset ID"
                            value="<?= isset($_GET['asset_id']) ? $_GET['asset_id'] : '' ?>">
                    </div>
                    <div class="col-md-4">
                        <input type="number" name="quantity" class="form-control" placeholder="Search by Quantity"
                            value="<?= isset($_GET['quantity']) ? $_GET['quantity'] : '' ?>">
                    </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                <td><img src="<?= $row['image'] ?>" alt="Asset Image" style="width: 50px; height: 50px;">
                                </td>
                                <td><?= $row['quantity'] ?></td>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="asset_name" class="form-control"
                                                        value="<?= $row['asset_name'] ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="asset_id" class="form-label">Asset ID</label>
                                                    <input type="text" name="asset_id" class="form-control"
                                                        value="<?= $row['asset_id'] ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="quantity" class="form-label">Quantity</label>
