    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid pb-0">
                ...
                $current_year = date("Y");
                $empedit = $_GET['empeditid'];
                // Build the base query
                $query = "SELECT * FROM hrm_employee WHERE status = 1 AND id = $empedit";
                                    ...
                                    <div class="card shadow-sm border-0 rounded-3">
                                        ...
                                        <div class="card-body">
                                            <?php if (isset($row['id'])) { ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 bg-light p-3 text-center border">
                                                        <!-- Profile Image -->
                                                        <div class="col-md-3 text-center">
                                                            <?php if ($row['image'] != "") { ?>
                                                                <div id="targetLayer">
                                                                    <img src="upload-image/<?php echo $row['image']; ?>"
                                                                        class="rounded-circle shadow-sm border" height="120" width="120"
                                                                        alt="User Image">
                                                                </div>
                                                            <?php } ?>
                                                        </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            <form name="image_form" id="image_form" method="post"
                                                                enctype="multipart/form-data" action="profile-image-upload.php"
                                                                class="d-flex align-items-center gap-2">
                                                                <input type="hidden" name="emp_id_for_image" id="emp_id_for_image"
                                                                    value="<?php echo $row['id']; ?>">

                                                                <label for="img1" class="btn btn-outline-primary btn-sm">Select
                                                                    Image</label>
                                                                <span id="file-selected" class="text-muted small"></span>
                                                                <input type="file" name="img1" id="img1" class="d-none">
                                                                <button type="submit" name="button_image" id="button_image"
                                                                    class="btn btn-success btn-sm">Upload</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 bg-white p-3 text-center border">
                                                        <!-- Employee Details -->
                                                        <div class=" pt-3">
                                                            <p><strong>Employee ID:</strong>
                                                                <?php echo htmlspecialchars($row['emp_id']); ?></p>
                                                            <!-- <p><strong>Job Title:</strong>
                                                                <?php echo htmlspecialchars($row['job_title']); ?></p> -->
                                                            <p><strong>Designation:</strong>
                                                                <?php if ($row['designation_id'] != 0 && $row['designation_id'] != "") {
                                                                    echo htmlspecialchars(get_value("hrm_designation", "name", $row['designation_id']));
                                                                } ?>
                                                            </p>
                                                            <p><strong>Department:</strong>
                                                                <?php if ($row['department_id'] != 0 && $row['department_id'] != "") {
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="f1" id="f1" method="post" action="#">
                                            <div class="profile-widget">
                                                ...
                                                <input type="hidden" name="id<?php echo $row_edit['id']; ?>"
                                        ...
                                        <form name="f2" id="f2" action="#" method="post">
                                            <div class="profile-widget">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <select name="house_type<?php echo $row_edit['id']; ?>"
                                                                id="house_type<?php echo $row_edit['id']; ?>"
                                                                class="form-control">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label">Staying at Current Residence Since
                                                ...
                                                <input type="hidden" 
                                                        ...
                                                        name="linkedin<?php echo $row_edit['id']; ?>"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <div class="cal-icon1">
                                                                <input
                                                                    value="<?php echo date("Y-m-d", strtotime($row['doj'])); ?>"
                                                                    class="form-control"
                                                                    name="doj<?php echo $row_edit['id']; ?>"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <select name="experience<?php echo $row_edit['id']; ?>"
                                                                id="experience<?php echo $row_edit['id']; ?>"
                                                                class="form-control">
