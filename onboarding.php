...
if ($selected_employee_id) {
    // Fetch all steps from onboarding_steps
    $all_steps_sql = "SELECT step_id FROM onboarding_steps ORDER BY step_order ASC";
    $all_steps_result = $conn->query($all_steps_sql);
    $all_steps = $all_steps_result->fetch_all(MYSQLI_ASSOC);

    // Fetch existing steps for this employee
    $existing_steps_sql = "SELECT step_id FROM employee_onboarding_steps WHERE employee_id = ?";
...
// Fetch employees
$emp_query = "SELECT id, fname, lname, email, doj FROM hrm_employee WHERE id !=14";
$emp_result = $conn->query($emp_query);
$employees = $emp_result->fetch_all(MYSQLI_ASSOC);

// Fetch all onboarding steps for the selected employee, sorted by step_order
$steps = [];
if ($selected_employee_id) {
...
<head>
    ...
    <style>
        ...
        .accordion-button { background-color: rgb(246, 4, 0) !important; color: white !important; }
        ...
        <div class="container padding-top-ams">
            <div class="container mt-5">
                ...
                <div class="search-container">
                    ...
                    <div class="mt-2">
                        <a href="onboardingtest.php" class="btn btn-primary"><i class="fas fa-cog"></i> Manage Onboarding Steps</i></a>
                    </div>
                </div>
